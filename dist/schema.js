...
const ExecuteCommandInPodSchema = z.object({
    ...
    fieldSelector: z
        .string()
        .describe("A selector to restrict the list of returned objects by their fields")
        .optional(),
    labelSelector: z
        .string()
        .describe("A selector to restrict the list of returned objects by their labels")
        .optional(),
    containerName: z
        .string()
...
export { CreateNamespaceSchema, ExecuteCommandInPodSchema, ListConfigMapsSchema, ListNamespacesSchema, ScaleDeploymentSchema, };
