...
function registerKubernetesTools(server) {
    ...
    server.tool("create_namespace", "Creates a new namespace in the Kubernetes cluster", CreateNamespaceSchema.shape, async (args) => {
    ...
    server.tool("list_config_maps", "Lists all ConfigMaps in the Kubernetes cluster OR namespace (if specified)", ListConfigMapsSchema.shape, async (args) => {
    ...
    server.tool("scale_deployment", "Scales the replica count of a deployment in a Kubernetes namespace", ScaleDeploymentSchema.shape, async (args) => {
